...
function Hero() {
  return (
    <div className='flex flex-col relative justify-between items-center  min-h-screen p-3 mx-2 my-3 border bg-gradient-to-b from-white  to-[#a6d7ff5d] border-gray-400 rounded-[30px]'>
      <Navbar/>
     <div className=' flex flex-col md:flex-row md:w-[95%] justify-center items-center gap-10'>
        <div className='flex md:w-[40%] flex-col justify-center items-center gap-10'>
            ...
            <p className=' font-montserrat px-4 leading-8 text-center text-[#484848] font-semibold text-[24px]'>
